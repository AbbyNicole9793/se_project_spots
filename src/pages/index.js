import "./index.css"
import { settings, resetValidation, enableValidation, disableButton  } from "../scripts/validation.js";
...
function handleNewPostSubmit(e) {
  ...
  e.preventDefault();
  changeText(e, true)
  api.postCards({ name: imageCaptionInput.value, link: imageLinkInput.value })
    .then((data) => {
...
function handleDeleteSubmit(e) {
  ...
  api.deleteCards(selectedCardId)
  .then(() => {
    selectedCard.remove()
...
function getCardElement(data) {
  ...
  if (!liked) {
      ...
      .catch(console.error)
    } else api.unlikeCards(selectedCardId)
    .then((data) => {
      data.isLiked = false
...
function handleEditProfileSubmit(e) {
  ...
  e.preventDefault();
  changeText(e, true)
  api.updateProfileInfo({ name: profileNameInput.value, about: profileDescriptionInput.value })
    .then((data) => {
